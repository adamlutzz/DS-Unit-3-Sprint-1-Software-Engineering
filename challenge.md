...
- Question 1: To me the most important thing to be pointed out in a code review </br>
is the readability of your code. Having a different set of eyes looking at your </br>
code is the best way to asses this.

- Question 2: Containers allow you to run multiple instances on one machine via </br>
virtual environments. This is a much eaiser way to manage all of the environments <br/>
from one place
